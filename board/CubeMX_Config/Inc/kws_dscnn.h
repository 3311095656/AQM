/**
  ...
  ******************************************************************************
  */
#ifndef AI_KWS_DSCNN_H
#define AI_KWS_DSCNN_H

#include "kws_dscnn_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_KWS_DSCNN_MODEL_NAME          "kws_dscnn"
#define AI_KWS_DSCNN_ORIGIN_MODEL_NAME   "kws_dscnn_int8"

/******************************************************************************/
#define AI_KWS_DSCNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_KWS_DSCNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_KWS_DSCNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_KWS_DSCNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_KWS_DSCNN_IN \
  ai_kws_dscnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_KWS_DSCNN_IN_SIZE { \
  AI_KWS_DSCNN_IN_1_SIZE, \
}
#define AI_KWS_DSCNN_IN_SIZE_BYTES { \
  AI_KWS_DSCNN_IN_1_SIZE_BYTES, \
}
#define AI_KWS_DSCNN_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_KWS_DSCNN_IN_1_HEIGHT      (98)
#define AI_KWS_DSCNN_IN_1_WIDTH       (40)
#define AI_KWS_DSCNN_IN_1_CHANNEL     (1)
#define AI_KWS_DSCNN_IN_1_SIZE        (3920)
#define AI_KWS_DSCNN_IN_1_SIZE_BYTES  (3920)

/******************************************************************************/
#define AI_KWS_DSCNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_KWS_DSCNN_OUT \
  ai_kws_dscnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_KWS_DSCNN_OUT_SIZE { \
  AI_KWS_DSCNN_OUT_1_SIZE, \
}
#define AI_KWS_DSCNN_OUT_SIZE_BYTES { \
  AI_KWS_DSCNN_OUT_1_SIZE_BYTES, \
}
#define AI_KWS_DSCNN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_KWS_DSCNN_OUT_1_CHANNEL     (10)
#define AI_KWS_DSCNN_OUT_1_SIZE        (10)
#define AI_KWS_DSCNN_OUT_1_SIZE_BYTES  (10)

/******************************************************************************/
#define AI_KWS_DSCNN_N_NODES (11)
 ...
 * @ref ai_kws_dscnn_create. Both the activations memory buffer 
 ...
 * using @ref ai_kws_dscnn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_kws_dscnn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_kws_dscnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_KWS_DSCNN_*
 * defines into file @ref kws_dscnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_kws_dscnn_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_KWS_DSCNN_H */
